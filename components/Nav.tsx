    ...
    <div>
        <nav className='w-screen h-40 flex align-middle text-align items-center fixed top-0'>
            <div className='container flex flex-wrap items-center mx-auto p-2 justify-center'>
                <a className='py-2 px-6 rounded-md hover:bg-pink-500 font-mono text-white mx-2' href="/">Home</a>
                <a className='py-2 px-6 rounded-md hover:bg-pink-500 font-mono text-white mx-2' href="/login">Projects</a>
                <a className='py-2 px-6 rounded-md hover:bg-pink-500 font-mono text-white mx-2' href="/register">Work</a>
            </div>
                <div className="before:block before:absolute before:-inset-3 before:-skew-y-3 before:bg-pink-500 relative inline-block">
